                            ...
                            <td>
                                <span class="text-ellipsis">
                                    @if ($cate_pro->category_status == 1)
                                        <!-- Nếu đang kích hoạt, hiển thị nút để hủy kích hoạt -->
                                        <a
                                            href="{{ route('category.product.unactive', ['category_product_id' => $cate_pro->category_id]) }}">
                                            <span class="fa-thumb-styling fa fa-thumbs-down"></span>
                                        </a>
                                    @else
                                        <!-- Nếu không kích hoạt, hiển thị nút để kích hoạt -->
                                        <a
                                            href="{{ route('category.product.active', ['category_product_id' => $cate_pro->category_id]) }}">
